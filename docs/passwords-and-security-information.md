...
When you log in to ADAM with a new password, ADAM will check your password against the [haveibeenpwned.com](https://haveibeenpwned.com/Passwords) database of over 500 million compromised passwords. If it discovers that the password has been used before, it records how many times it has been used. We’re hoping it isn’t there at all!
