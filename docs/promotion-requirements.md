# Promotion Requirements {#h-rjefff}

The promotion decisions are based on ADAM’s Promotion Requirements. The set of criteria for a pupil are based on that pupil’s grade and their qualification. If they are not specifically registered for a qualification, then the default qualification as set in the [Reporting Period Settings](reporting-period-administration.md#h-1a346fx) is used.

## Interpreting ADAM’s promotion decisions {#h-gxqaj15mdox0}
...
Where a pupil has been listed as failed, note carefully the checks that ADAM lists. This may give you a clue as to why the pupil did not pass. Specifically, make sure that the pupil belongs to the qualification you imagine they should (or “default”) in the [pupil details](pupil-information.md#h-4fsjm0b) and that there are appropriate promotion requirements for that grade and qualification.

ADAM will only check against promotion criterion that match the pupils’ grade and qualifications.

## Recalculating promotion decisions {#h-j8ku5wt7uzk}
...
## Managing Promotion Decisions {#h-om8f5ivd7nvu}
...
## National Senior Certificate Promotion Criteria {#h-8s0sjwmveowa}
...
## Promotions for Pupils with Immigrant Status {#h-2ehv1dhir1mq}
...
### Creating a Qualification {#h-d3ao946j7smt}

The first step is to create a specific qualification that will be used to “house” the promotion criteria that will need to be applied to pupils with immigrant status. The details of adding and otherwise [managing qualifications is dealt with elsewhere in this documentation](#h-d3ao946j7smt). Make sure to replicate the same symbol sets so that ADAM knows the marks that are referred to by each symbol.

### Overriding the Qualification for Individual Pupils {#h-b2y9g78ap2h8}
...
However, it is possible to tell ADAM that for specific pupils, a different qualification will apply. Again, assigning a specific qualification [to an individual pupil is dealt with elsewhere](academic-qualifications.md#h-19yhnak0mm6).

### Creating the Promotion Criteria {#h-5unaspi3pgay}
...
## Creating your Own Promotion Criteria {#h-hi1v4ydbfwxq}
...
## Explanation of Syntax of the Criteria {#h-1qoc8b1}
...
### Where are the subject codes? {#h-kercqkfwo6z9}
...
### What is the difference between an Internal Subject Code and a DBE Subject Code? {#h-w8gmqeczh5su}
...
### How strict is the syntax? {#h-14ykbeg}
...
### Templates for Typical Promotion Requirements {#h-243i4a2}
...
#### Promoted (Grades 10 – 12) BD {#h-j8sehv}
...
#### Promoted (Grades 10 – 12) D {#h-338fx5o}
...
#### Promoted (Grades 10 – 12) HC {#h-1idq7dh}
...
#### Promoted (Grades 10 – 12) {#h-42ddq1a}
...
#### Promoted - Language Exemption (Grades 10 – 12) BD\* {#h-o1f10jjlo9ld}
...
#### Promoted - Language Exemption (Grades 10 – 12) D\* {#h-c87y1t4wexj2}
...
#### Promoted - Langauge Exemption (Grades 10 – 12) HC\* {#h-nl4ubsagk2yy}
...
#### Promoted - Language Exemtption (Grades 10 – 12)\* {#h-sc848kpng839}
...
#### Promoted (General Education and Training Phase) {#h-b44n57qhee6}
...
#### Promoted (Intermediate Phase) {#h-a6jabv5lobkl}
...
### To list all pupils as promoted without performing any checks {#h-2hio093}

#### Details to Enter: {#h-unq8pej45fn4}
...
#### Criteria to copy-and-paste: {#h-nbataknz2tx2}
...
## How are the conditions used? {#h-4anzqyu}
...
## How the promotion conditions work together {#h-2pta16n}
