...
Each time a setting is changed, the system administrator, as configured in the settings, is emailed. If the system administrator’s address is changed, the *old* address is used for the confirmation email.
