...
![](assets/screenshots/report-publishing/report-publishing-02.png)
...
![](assets/screenshots/report-publishing/report-publishing-03.png)
...
![](assets/screenshots/report-publishing/report-publishing-05.png)
...
#### Signature is too big or too small
...
![](assets/screenshots/report-publishing/report-publishing-07.png)
...
![](assets/screenshots/report-publishing/report-publishing-09.png)

Next choose a class of pupils to send to. Please don’t choose a class that has pupils from multiple grades.

![](assets/screenshots/report-publishing/report-publishing-10.png)
...
### Reverting back to a templated report
...
![](assets/screenshots/report-publishing/report-publishing-13.png)
...
Some background to this process: Each time ADAM generates the report, it puts a temporary copy in the [Document Repository](document-repository.md#document-repository). This copy is temporary until the publishing date passes and then ADAM marks the archived report as finalised. After this time, any changes that are made to the report and its contents are not reflected on the report because the archived copy is no longer updated.
...
#### Reason 2: The report data (marks and comments) haven’t changed
...
![](assets/screenshots/report-publishing/report-publishing-16.png)
...
![](assets/screenshots/report-publishing/report-publishing-17.png)
