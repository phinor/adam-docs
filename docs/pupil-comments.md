...
## Comment Categories {#h-fc44iii025v8}
...
![](assets/screenshots/pupil-comments/pupil-comments-01.png)
...
### Adding and editing Comment Categories {#h-n6dg2hjj9sk4}

When adding or editing a comment category, the following screen will appear:

![](assets/screenshots/pupil-comments/pupil-comments-02.png)
...
## Entering Pupil Comments {#h-wzy2dptv5edf}
...
![](assets/screenshots/pupil-comments/pupil-comments-03.png)

The following screen is shown:

![](assets/screenshots/pupil-comments/pupil-comments-04.png)

The **Category** refers to the comment categories that were [described above](#h-fc44iii025v8).
...
The next option will restrict the visibility of the comment to specific privilege groups. The groups listed here are ones that have been given **secondary privilege status** (see [staff privilege groups](security-administration-for-staff.md#h-thw4kt) for more information). On a default setup, schools would only see “All staff” listed as an option here and additional groups would need to be added.
...
The **Email Parents** option may or may not be enabled depending on how the [comment category was set up](#h-fc44iii025v8).
...
Finally, if the user has [permissions to add documents](document-repository.md#h-a6043un8am4k) to any [document repository category](document-repository.md#h-4k668n3), they will see a **Supporting Documentation** option at the bottom. Note that this only appears if it can be used.
