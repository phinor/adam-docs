# Level Descriptors {#h-pkwqa1}

In typical usage each grade is assigned to a specific [qualification](academic-qualifications.md#h-lnxbz9) in the [reporting period settings](reporting-period-administration.md#h-1a346fx). It is possible to [assign a pupil directly to a qualification](academic-qualifications.md#h-19yhnak0mm6) which would override the qualification that might otherwise apply via this mechanism.
...
While in typical usage, all subjects make use of the same symbols, it is possible to configure ADAM so that individual Subject or individual Learning Outcomes within subjects use customised qualifications. See the [Qualification](academic-qualifications.md#h-zc0sv9z7mzke) section for more information.

## Editing Level Descriptors {#h-6a8lnab0ex1v}
...
1.  **The lower bound percentage.** This is the minimum mark required for ADAM to award this level. Please see [the note below](#h-7ay8rm5e3nx5) if you are working on levels for the Foundation Phase or any other non-marks-based assessment setup.
...
### A Note on Percentages for Non-mark-based Assessment Phases {#h-7ay8rm5e3nx5}
...
### A Note on Editing Levels Descriptors used in Previous Years {#h-7mfi7h84mvxt}
...
1.  Create a [new qualification](academic-qualifications.md#h-35nkun2)
2.  [Add the levels](#h-6a8lnab0ex1v) to the qualification
3.  Assign the qualification [to the grade](reporting-period-administration.md#h-u5xim02o9rs5) or [individual pupils](academic-qualifications.md#h-19yhnak0mm6)
