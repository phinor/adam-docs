...
## Applying Updates Manually {#h-a70b1ukm7y5v}
...
### To apply an automatically downloaded update {#h-4arjxzkugsl4}
...
### To apply an update file sent by email {#h-c1swrph62yb8}
